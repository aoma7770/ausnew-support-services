...
export const leads = mysqlTable("leads", {
  ...
  sourceType: mysqlEnum("sourceType", ["website_form", "janice_chat"]).default("website_form").notNull(),
  leadSummary: text("leadSummary"),
  supportDetails: text("supportDetails"),
  location: varchar("location", { length: 256 }),
  preferredStartTime: varchar("preferredStartTime", { length: 256 }),
  expectedDuration: varchar("expectedDuration", { length: 256 }),
  preferredContactTime: varchar("preferredContactTime", { length: 256 }),
  relationshipToParticipant: varchar("relationshipToParticipant", { length: 128 }),
  ndisPlanStatus: varchar("ndisPlanStatus", { length: 256 }),
  conversationTranscript: text("conversationTranscript"),
  zapierDeliveryStatus: mysqlEnum("zapierDeliveryStatus", ["not_applicable", "pending", "delivered", "failed"]).default("not_applicable").notNull(),
  zapierDeliveredAt: timestamp("zapierDeliveredAt"),
  zapierError: varchar("zapierError", { length: 512 }),
